namespace ClickHouse.Ado.Impl.Settings
{
    ...
    internal class QuerySettings
    {
        private static readonly Dictionary<string, SettingValue> SettingDefaults = new Dictionary<string, SettingValue>
                                                                                   {
...

                                                                                       {
                                                                                           ...
                                                                                           new UInt64SettingValue(65536)
                                                                                       },

                                                                                       {
                                                                                           "max_compress_block_size",
                                                                                           new
                                                                                               UInt64SettingValue(1048576)
                                                                                       },
...

                                                                                       {
                                                                                           "interactive_delay",
                                                                                           new
                                                                                               UInt64SettingValue(100000)
                                                                                       },

                                                                                       {
                                                                                           "connect_timeout",
                                                                                           new TimeSpanSettingValue(10)
                                                                                       },
...

                                                                                       {
                                                                                           ...
                                                                                           new
                                                                                               TimeSpanMsSettingValue(50)
                                                                                       },

                                                                                       {
                                                                                           "receive_timeout",
                                                                                           new TimeSpanSettingValue(400)
                                                                                       },
...

                                                                                       {
                                                                                           ...
                                                                                           new UInt64SettingValue(60)
                                                                                       },


                                                                                       {
                                                                                           "load_balancing",
                                                                                           new EnumSettingValue<
                                                                                               LoadBalancing
                                                                                       ...
                                                                                       {
                                                                                           "global_subqueries_method",
                                                                                           new EnumSettingValue<
                                                                                               GlobalSubqueriesMethod
                                                                                           >(GlobalSubqueriesMethod
                                                                                                .Push)
                                                                                       },
        ...
        public void Set(string name, ulong value)
        {
            ...
            if (def.GetType() != typeof(UInt64SettingValue))
            {
        ...
        {
            var def = SettingDefaults[name];
            if (def.GetType() != typeof(BoolSettingValue))
            {
                throw new InvalidCastException();
            }
        ...
        public void Set(string name, TimeSpan value)
        {
            ...
            {
                if (def.GetType() != typeof(TimeSpanMsSettingValue))
                {
                    throw new InvalidCastException();
                }
        ...
        {
            var def = SettingDefaults[name];
            if (def.GetType() != typeof(StringSettingValue))
            {
                throw new InvalidCastException();
            }
        ...
        {
            return Get<T>(name, useDefaults, out _);
        }
        ...
        {
            return Get(name, useDefaults, out _);
        }
